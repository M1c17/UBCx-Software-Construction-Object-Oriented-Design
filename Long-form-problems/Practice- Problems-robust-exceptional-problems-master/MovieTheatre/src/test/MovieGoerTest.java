...
public class MovieGoerTest {
    ...
    public void testBuyTicketNoUnderAgeException() {
        try {
            mg1.buyTicket(m1);
        } catch (ShowingFullException | UnderAgeException e) {
            fail("There should have not problems");
        }

        assertEquals(m1.getCurrentSeating(), 1);
    ...
    public void testBuyTicketUnderAgeException() {
        try {
            ...
            fail("There still are seating to the movie");
        } catch (UnderAgeException e) {

        }
        assertEquals(m1.getCurrentSeating(), 0);
    ...
    public void testBuyTicketShowingFullException() {
        ...
        try {
            ...
            System.out.println("Sorry the are no space");
        } catch (UnderAgeException e) {
